        ...
        for i, doctor in enumerate(filtered_doctors):
            with st.container():
                ...
                <div style="
                    ...
                    padding: 15px;
                    margin-bottom: 15px;
                    border-left: 5px solid {'#4CAF50' if doctor['rating'] >= 4.5 else '#FFC107' if doctor['rating'] >= 3.5 else '#F44336'};
                ">
                    <h3>{doctor['name']}</h3>
                    <p style="margin-bottom: 8px;">
                        <span style="font-weight: bold;">{specialty}</span> • {doctor['experience']} years experience • 
                        {'⭐' * int(doctor['rating'])} {doctor['rating']}/5 
                        {' • <span style="color: green;">Available Today</span>' if doctor['available_today'] else ''}
                    </p>
                    <p style="margin-bottom: 0px;">
                        <span style="font-weight: bold;">Hospital:</span> {doctor['hospital']} 
                    </p>
                    <p style="margin-bottom: 0px;">
                        <span style="font-weight: bold;">Languages:</span> {', '.join(doctor['languages'])}
                    </p>
                    <p style="margin-bottom: 0px;">
                        <span style="font-weight: bold;">Education:</span> {doctor['education']}
                    </p>
                    <p style="margin-bottom: 0px;">
                        <span style="font-weight: bold;">Contact:</span> {doctor['phone']}
                    </p>
                    <p style="margin-bottom: 0px;">
